...
Using this simple, augmented if required, model to identify forecastable profitability.
...
plotly::plot_ly(x = perfect_netprofit_eth, 
                y = ar1_netprofit_eth, color = 1:460,
                type = "scatter") %>%
...
plot_ly(data = open_close[300:460, ], 
        x = ~(close-open),
        y = ar1_netprofit_eth[300:460],
        color = 300:460, 
        hovertext = 300:460) %>%
