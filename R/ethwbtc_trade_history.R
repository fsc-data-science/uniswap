...
#'   \item{liquidity_adjusted}{The total liquidity available that includes the tick of the trade. Changes from liquidity withdrawal, deposits, and when price exists a position(s) range}
